...
static MantiqQubit g_quantum_state[64];
static int g_quantum_initialized = 0;
static int g_quantum_next_id = 0;

static void mantiq_quantum_init_once(void) {
    if (!g_quantum_initialized) {
        memset(g_quantum_state, 0, sizeof(g_quantum_state));
        for (int i = 0; i < 64; i++) {
            g_quantum_state[i].alpha_re = 1.0; // |0> state
            g_quantum_state[i].alpha_im = 0.0;
            g_quantum_state[i].beta_re = 0.0;
            g_quantum_state[i].beta_im = 0.0;
            g_quantum_state[i].measured = 0;
            g_quantum_state[i].measured_val = 0;
        }
        g_quantum_initialized = 1;
    }
}

int32_t mantiq_quantum_qbit(int32_t initial_state) {
    mantiq_quantum_init_once();
    int id = (g_quantum_next_id++) % 64;
    if (initial_state == 1) {
        g_quantum_state[id].alpha_re = 0.0;
        g_quantum_state[id].beta_re = 1.0; // |1>
    } else {
        g_quantum_state[id].alpha_re = 1.0; // |0>
        g_quantum_state[id].beta_re = 0.0;
    }
    g_quantum_state[id].alpha_im = 0.0;
    g_quantum_state[id].beta_im = 0.0;
    g_quantum_state[id].measured = 0;
    g_quantum_state[id].measured_val = 0;
    return id;
}
...
int32_t mantiq_quantum_h(int32_t q) {
    ...
    double a_re = g_quantum_state[id].alpha_re;
    double a_im = g_quantum_state[id].alpha_im;
    double b_re = g_quantum_state[id].beta_re;
    double b_im = g_quantum_state[id].beta_im;

    g_quantum_state[id].alpha_re = (a_re + b_re) * inv_sqrt2;
    g_quantum_state[id].alpha_im = (a_im + b_im) * inv_sqrt2;
    g_quantum_state[id].beta_re = (a_re - b_re) * inv_sqrt2;
    g_quantum_state[id].beta_im = (a_im - b_im) * inv_sqrt2;
    g_quantum_state[id].measured = 0;
    return id;
}
...
int32_t mantiq_quantum_measure(int32_t q) {
    ...
    int id = q % 64;
    if (id < 0) id = -id;
    if (g_quantum_state[id].measured) {
        return g_quantum_state[id].measured_val;
    }
    double p0 = g_quantum_state[id].alpha_re * g_quantum_state[id].alpha_re +
                g_quantum_state[id].alpha_im * g_quantum_state[id].alpha_im;
    int res = 0;
    if (p0 < 0.000001) {
        res = 1;
    } else if (p0 > 0.999999) {
        ...
        // Deterministic/probabilistic collapse
        static unsigned int seed = 123456789;
        seed = (1103515245 * seed + 12345) & 0x7fffffff;
        double r = (double)seed / 2147483648.0;
        res = (r >= p0) ? 1 : 0;
    }
    g_quantum_state[id].measured = 1;
    g_quantum_state[id].measured_val = res;
    if (res == 1) {
        g_quantum_state[id].alpha_re = 0.0;
        g_quantum_state[id].alpha_im = 0.0;
        g_quantum_state[id].beta_re = 1.0;
        g_quantum_state[id].beta_im = 0.0;
    } else {
        g_quantum_state[id].alpha_re = 1.0;
        g_quantum_state[id].alpha_im = 0.0;
        g_quantum_state[id].beta_re = 0.0;
        g_quantum_state[id].beta_im = 0.0;
    }
...
void mantiq_quantum_cnot(int32_t ctrl, int32_t target) {
    mantiq_quantum_init_once();
    int c_id = ctrl % 64;
    int t_id = target % 64;
    if (c_id < 0) c_id = -c_id;
    if (t_id < 0) t_id = -t_id;
    double p1 = g_quantum_state[c_id].beta_re * g_quantum_state[c_id].beta_re +
                g_quantum_state[c_id].beta_im * g_quantum_state[c_id].beta_im;
    if (p1 > 0.5) {
        double tmp_re = g_quantum_state[t_id].alpha_re;
        double tmp_im = g_quantum_state[t_id].alpha_im;
        g_quantum_state[t_id].alpha_re = g_quantum_state[t_id].beta_re;
        g_quantum_state[t_id].alpha_im = g_quantum_state[t_id].beta_im;
        g_quantum_state[t_id].beta_re = tmp_re;
        g_quantum_state[t_id].beta_im = tmp_im;
    }
    g_quantum_state[t_id].measured = 0;
}
...
int32_t mantiq_quantum_x(int32_t q) {
    ...
    int id = q % 64;
    if (id < 0) id = -id;
    double tmp_re = g_quantum_state[id].alpha_re;
    double tmp_im = g_quantum_state[id].alpha_im;
    g_quantum_state[id].alpha_re = g_quantum_state[id].beta_re;
    g_quantum_state[id].alpha_im = g_quantum_state[id].beta_im;
    g_quantum_state[id].beta_re = tmp_re;
    g_quantum_state[id].beta_im = tmp_im;
    g_quantum_state[id].measured = 0;
    return id;
}
...
int32_t mantiq_quantum_y(int32_t q) {
    ...
    double b_re = g_quantum_state[id].beta_re;
    double b_im = g_quantum_state[id].beta_im;
    g_quantum_state[id].alpha_re = b_im;
    g_quantum_state[id].alpha_im = -b_re;
    g_quantum_state[id].beta_re = -a_im;
    g_quantum_state[id].beta_im = a_re;
    g_quantum_state[id].measured = 0;
    return id;
}
...
int32_t mantiq_quantum_z(int32_t q) {
    ...
    int id = q % 64;
    if (id < 0) id = -id;
    g_quantum_state[id].beta_re = -g_quantum_state[id].beta_re;
    g_quantum_state[id].beta_im = -g_quantum_state[id].beta_im;
    g_quantum_state[id].measured = 0;
    return id;
}
